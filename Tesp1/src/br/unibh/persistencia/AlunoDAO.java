		...
		try {
			...
			if (res.next()) {
				return new Aluno(res.getLong("id"), res.getString("nome"), res.getString("cpf"),
						res.getString("matricula"), res.getString("data_aniversario") == null ? null : df
								.parse(res.getString("data_aniversario")));
			}
...
try {
			...
			String sql = ("update tb_aluno set nome = ?, "	+ "cpf = ?, matricula = ?, data_aniversario = ? " + "where id = ?");
		...
		try {
			...
			while (res.next()) {
				lista.add(new Aluno(res.getLong("id"), res.getString("nome"), res.getString("cpf"),
						res.getString("matricula"), res.getString("data_aniversario") == null ? 
								null : df.parse(res.getString("data_aniversario"))));
			}
